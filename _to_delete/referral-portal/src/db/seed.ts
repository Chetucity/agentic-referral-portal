...
db.delete(referralEvents).run();
db.delete(referrals).run();
db.delete(jobs).run();
db.delete(companyMembers).run();
...
db.insert(companies).values(companyRows).run();
...
db.insert(users).values(allUsers).run();

/* -------------------------------------------------------------------------- */
/* Company members                                                            */
/* -------------------------------------------------------------------------- */

db.insert(companyMembers)
  .values([
